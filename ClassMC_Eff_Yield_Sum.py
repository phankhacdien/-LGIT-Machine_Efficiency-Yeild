# -*- coding: utf-8 -*-
"""
Created on Fri Oct  8 11:55:38 2021
...
class Yield:
    ...
    @TimeIs
    def YieldSummaryMain(self):
        # Read log file
        path_LT = DataHandling.SelectExcelFile(1)
        data_LT = DataHandling.ReadAndPreProcessData(path_LT)
        summary_tbl = self.YieldSummary(data_LT)
...
class Eff:
    ...
    def MachineEfficiency(self, Lot_time, Human_error):
        eff_LT = DataHandling.ConvertTime(Lot_time)
        eff_HM = DataHandling.ConvertTime(Human_error)
    ...
    @TimeIs
    def MachineEfficiencyMain(self):
        # Read log file
        path_LT = DataHandling.SelectExcelFile(1)
        path_HM = DataHandling.SelectExcelFile(2)
        
        data_LT = DataHandling.ReadAndPreProcessData(path_LT)
        data_HM = DataHandling.ReadAndPreProcessData(path_HM)
        
        # compute UPH
        [test_time_longest, handling_time] = self.ComputeUPH(data_LT)
        
        # Retest rate
        fail_items = [i for i in data_LT['ERROR'].unique() if i != '-']
        
        [retest_count_tbl, lcb_dp_tbl, total_test_count] = self.TakeRetestCountTable(data_LT, fail_items)
        
        # M/C Eff
        [eff_tbl, total_run_time] = self.MachineEfficiency(data_LT, data_HM)
        ...
        DataHandling.AppendDfToExcel("result.xlsx", retest_count_tbl['index'], sheet_name="result", startrow=23, startcol=1)
        DataHandling.AppendDfToExcel("result.xlsx", retest_count_tbl['initial'], sheet_name="result", startrow=23, startcol=7)
        DataHandling.AppendDfToExcel("result.xlsx", retest_count_tbl['1st_retest'], sheet_name="result", startrow=23, startcol=9)
        DataHandling.AppendDfToExcel("result.xlsx", retest_count_tbl['2nd_retest'], sheet_name="result", startrow=23, startcol=11)
        DataHandling.AppendDfToExcel("result.xlsx", retest_count_tbl['3rd_retest'], sheet_name="result", startrow=23, startcol=13)
        DataHandling.AppendDfToExcel("result.xlsx", lcb_dp_tbl['index'], sheet_name="result", startrow=75, startcol=1)
        DataHandling.AppendDfToExcel("result.xlsx", lcb_dp_tbl['initial'], sheet_name="result", startrow=75, startcol=7)
        DataHandling.AppendDfToExcel("result.xlsx", eff_tbl['Duration_time'], sheet_name="result", startrow=96, startcol=3)
        DataHandling.AppendDfToExcel("result.xlsx", eff_tbl['Convert time'], sheet_name="result", startrow=96, startcol=2)
        DataHandling.AppendDfToExcel("result.xlsx", eff_tbl['event'], sheet_name="result", startrow=96, startcol=4)